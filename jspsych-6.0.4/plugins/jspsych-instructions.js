    ...
    function show_current_page() {
      ...
      if (trial.show_clickable_nav) {
        ...
        if (trial.allow_backward) {
          ...
          nav_html += "<button id='jspsych-instructions-back' class='jspsych-btnm' style='margin-right: 5px;' "+allowed+">&lt; "+trial.button_label_previous+"</button>";
        }
        if (trial.pages.length > 1 && trial.show_page_number) {
            nav_html += pagenum_display;
        }
        nav_html += "<button id='jspsych-instructions-next' class='jspsych-btnm'"+
